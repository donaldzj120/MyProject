...
class Ctm_mis_create extends Controller {
	...
	function index()
	{
		...
		$renban = $query['renban'] + 1;

		$data['sagyo_id1'] = $query['bangou'];
		$data['sagyo_id2'] = str_pad($renban, 5, '0', STR_PAD_LEFT);

		$this->user_model->UpdateUserRenban($this->session->userdata('id'), $renban);
