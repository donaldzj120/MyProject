...
class Ctm_mis_confirm extends Controller {
...
*/
			...
			$query = $this->db->get_where('ka',
					array(
							'ka_name1' => $_POST['ka_name1'],
							'ka_name2' => $_POST['ka_name2'],
			                'ka_tel' => $_POST['ka_tel'],
			                'ka_add1' => $_POST['ka_add1'],
							'ka_add2' => $_POST['ka_add2'],
							'ka_add3' => $_POST['ka_add3'],
							'ka_post' => $_POST['ka_post'],
							'from_id' => $this->session->userdata('user_id'),
						)
			);

			$ka_array = $query->result_array();
			...
			if(empty($ka_array))
			{
				...
				$this->db->insert('ka', $ka_data);
			}


			$mail = $this->mylabels->ctmCreatedMis;
