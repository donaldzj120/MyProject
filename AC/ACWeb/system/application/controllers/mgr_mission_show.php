...
class Mgr_mission_show extends Controller {
	...
	function index()
	{
		...
		if ($this->uri->segment(2) == FALSE){
			...
			//任務データの取得
			$mission_data = $this->mission_model->GetMissionInfoById($id);
			...
			$week = date('w', strtotime($mission_data[0]['sagyo_date']));
			...
			$this->load->view('mgr_mission_show_view',$data);
