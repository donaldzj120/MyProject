...
<img src="<?php echo $base;?>images/haisou_menu.jpg" width="1026" height="37" />
  ...
  <div id="ct2">
  	<input type="text" name="sagyo_id1" value="<?php echo set_value('sagyo_id1'); ?>" size="7" maxlength="10" style="ime-mode: disabled;"/>-
    <input type="text" name="sagyo_id2" value="<?php echo set_value('sagyo_id2'); ?>" size="8" maxlength="10" style="ime-mode: disabled;"/>
  </div>
  <div id="ctmg1">
