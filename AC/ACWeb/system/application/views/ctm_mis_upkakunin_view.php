<td valign="top"><div class="title02">
  ...
  <?php echo form_open_multipart('ctm_mis_upconfirm'); ?>
  <input type="hidden" name="id" value="<?php if(!empty($query))echo $query['sagyo_id1'];else echo $id;?>" >
  ...
  <table class="kakunin" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" width="80%" align="center">
   ...
   <tr>
   	<td colspan="2" align="center" height="80" style='word-break:break-all;border-top:.5pt solid black;border-left:.5pt solid black;border-bottom:1.5pt solid black;'><?php echo $ka;?></td>
   	<td align="center" style='word-break:break-all;border-top:.5pt solid black;border-left:.5pt solid black;border-bottom:1.5pt solid black;'><?php echo $siji;?></td>
   </tr>
  </table>
