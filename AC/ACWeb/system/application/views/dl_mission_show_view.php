...
function DrawImage(ImgD){
 ...
 if(image.width>0 && image.height>0){
  ...
  <table class="mgr_kakunin" cellpadding="1" cellspacing="0" style="margin:0 auto;width:895px;">
  ...
  <table width="100%">
	<tr align="center">
		<td>
		<!-- <?php echo anchor('dl_nouhin/1/'.$id, '<img src="'.$base.'/images/button_nohinsyo.jpg" border="0"/>'); ?>
		<?php echo anchor('dl_nouhin/2/'.$id, '<img src="'.$base.'/images/button_uke.jpg" border="0"/>'); ?> -->
		<?php echo anchor('../PPF/nouhinPDF.php?missionID='.$id, '<img src="'.$base.'/images/_r16_c2.jpg" border="0"/>', array('target' => '_blank')); ?>
