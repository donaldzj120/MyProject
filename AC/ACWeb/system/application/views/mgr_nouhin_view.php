...
<table class="kakunin" border="0" cellpadding="1" cellspacing="0" width="100%">
 ...
 <tr>
  <td width="10%" height="20"></td>
  <td width="80%" style='border-right:1.5pt solid black;'><?php echo $ps['ka_add1'].'<br>';echo str_replace(',','',$ps['ka_add2']);?></td>
 </tr>
 <tr>
  <td width="10%" height="20"></td>
...
<table class="kakunin" border="0" cellpadding="1" cellspacing="0" width="100%">
 ...
 <tr>
  <td width="10%" height="20"></td>
  <td width="80%" style='border-right:1.5pt solid black;'><?php echo $ps['todoke_add1'].'<br>';echo str_replace(',','',$ps['todoke_add2']);?></td>
 </tr>
 <tr>
  <td width="10%" height="20"></td>
...
<table class="kakunin" border="0" cellpadding="1" cellspacing="0" width="100%">
 <tr height="25">
  ...
  <td align="left" width="80%" style='border-left:.5pt solid black;border-bottom:1.5pt solid black;border-top:1.5pt solid black;border-right:1.5pt solid black;'>&nbsp;<?php echo $hiccyaku;?><?php echo $formlabels['hiccyaku'];?>&nbsp;&nbsp;<?php echo $ps['tokki'];?></td>
 </tr>
</table>
<br />
<?php if($kubun == 1) {?>
